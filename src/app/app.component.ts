...
export class AppComponent implements AfterViewInit,OnInit {
	title = 'Pranav Pratap Singh (PranavPratapSingh)\'s Personal Portfolio';
	...
	ngOnInit(){
		...
		console.log("%chttps://github.com/PranavPratapSingh/PranavPratapSingh.github.io", "font-size:17px");
	}
