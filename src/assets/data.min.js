...
const data = {
	...
	Home: {
		introduction:
			"I’m a Software Development Engineer at Amazon, specializing in Machine Learning, Neural Networks, and Distributed Systems, with a focus on building intelligent systems and Generative AI solutions.",
	...
	About: {
		...
		about: {
			...
			bio: "I am a motivated and accomplished professional working as a Software Development Engineer at Amazon. With expertise in neural networks, machine learning, and distributed systems, I am passionate about pushing technological boundaries and building innovative, intelligent solutions, including Generative AI applications.",
			"IDE, Editors & Tools": [
				"Git",
				"Docker",
				"Amazon Web Services",
		...
		proficiency: [
			...
			[
				...
				{ proficiency: "Swift", progress: "80" },
				{ proficiency: "C#", progress: "80" },
			],
		],
		education: [
			{
	...
	Experience: [
		{
			animationClass: "Left right",
			textAlignment: "left",
			designation: "Software Development Engineer (AI/ML)",
			companyname: "Amazon Inc",
			duration: "Jun 2025 - Present",
			description:
				"Spearheaded creation of Generative BI Agents, enabling real-time conversational insights. Developed intelligent, context-aware solutions that improved decision-making efficiency and user experience. Drove adoption of scalable AI capabilities across multiple teams.”",
			// percentage: "GPA:4.0",
		},
		{
			animationClass: "Right left",
			textAlignment: "right",
			designation: "Extern Graduate Researcher",
			companyname: "Meta (FAIR)",
			duration: "Feb 2025 - May 2025",
			description:
				"Developed methods to improve diversity and reduce bias in LLM-generated synthetic data, designing attributed prompts and fine-tuning strategies that enhanced output variety while maintaining high quality, achieving up to 95% cost efficiency compared to standard prompting approaches.",
			// percentage: "GPA:4.0",
		},
		{
			animationClass: "Left right",
			...
			companyname: "Sigma Solve Inc",
			duration: "May 2024 - Aug 2024",
			description:
				"At Sigma Solve Inc., I spearheaded the development of YOLO models for F1 race footage, achieving 90% detection accuracy. By leading the end-to-end execution of F1 highlight extraction projects, I integrated cutting-edge AI technologies to deliver precise and captivating race highlights, enhancing viewer engagement and transforming the motorsport viewing experience.",
			// percentage: "GPA:4.0",
		},
		{
			animationClass: "Right left",
			...
			[
				{
					...
					description:
						"An iOS application developed in Swift, featuring a Tinder-like swipe interface to efficiently declutter and organize your photo library",
				},
				{
					class: "Down",
					title: "Football Manager: Hierarchical Video Retrieval",
					subtitle: "Prof. Grant Van Horn",
					date: "Sep 2024 – Dec 2024",
					description:
						"Developed a hierarchical framework using CLIP and VideoLLaMA2 for soccer event retrieval. Improved precision for rare events from 0% to 40% and achieved real-time performance with 15-second latency for 90-minute videos.",
				},
				{
					class: "Right",
					title: "Multi-View 3D Point Cloud Generation for Visual-Language Models",
					subtitle: "Prof. Chuang Gan",
					date: "15 May 2024 - Dec 2024",
					description:
						"Using the DROID dataset, we generate precise 3D point clouds from video frames to enhance visual-language models with the Iterative Closest Point (ICP) algorithm.",
					link: "16B_NM1Sl3p1WvoWBSHaP-1aej6K6It1-",
				},
			],
			[
				{
				...
				{
					class: "",
					title: "PhotoEditingPipeline",
					subtitle: "",
					date: "Dec 2023 – Jan 2024",
					description:
						"A robust serverless image processing pipeline leveraging Azure Functions and Durable Functions. This system dynamically handles tasks like resizing, watermarking, metadata extraction, and format conversion, enabling scalable and automated photo editing workflows for diverse use cases",
				},
			],
			[
				// {
